...
<h1 align="center">@lobehub/webfont-harmony-sans-sc-mini</h1>

<div align="center">

Subset webfont package for HarmonyOS Sans SC (Unicode-range split)
...
`@lobehub/webfont-harmony-sans-sc-mini` uses `unicode-range` to split HarmonyOS Sans SC into:

- one base subset for Latin, punctuation and symbols
- ten CJK subsets for basic Han characters (`U+4E00` to `U+9FA5`)

This significantly reduces first paint font payload for mixed-language pages.
...
Copyright © 2026 [LobeHub][profile-url]. <br />
...
[release-shield]: https://img.shields.io/npm/v/@lobehub/webfont-harmony-sans-sc-mini?label=%F0%9F%A4%AF%20NPM
[release-url]: https://www.npmjs.com/package/@lobehub/webfont-harmony-sans-sc-mini
